...
Github Actions is configured with yaml files in the [.github/workflows](../../.github/workflows) directory. It will attempt to build the Design System, run the linter and run tests for every
...
The Github Actions deployment script is detailed in [.github/workflows/deploy.yaml](../../.github/workflows/deploy.yaml)
